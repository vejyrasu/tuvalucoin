...
int64_t GetProofOfWorkReward(unsigned int nBits, int64_t nFees)
{
    ...
    // TestCoin: subsidy is cut in half every 64x multiply of PoW difficulty
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, unsigned int nBits, unsigned int nTime, bool bCoinYearOnly)
{
    ...
    if(fTestNet || nTime > STAKE_SWITCH_TIME)
    {
        ...
        // TestCoin: A reasonably continuous curve is used to avoid shock to market
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TestCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // TestCoin: check proof-of-stake block signature
