...
const string strMessageMagic = "TuvaluCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(unsigned int nBits, int64_t nFees)
{
    ...
    // TuvaluCoin: subsidy is cut in half every 64x multiply of PoW difficulty
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, unsigned int nBits, unsigned int nTime, bool bCoinYearOnly)
{
    ...
    if(fTestNet || nTime > STAKE_SWITCH_TIME)
    {
        ...
        // TuvaluCoin: A reasonably continuous curve is used to avoid shock to market
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("tuvalucoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TuvaluCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // TuvaluCoin: check proof-of-stake block signature
...
// tuvalucoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TuvaluCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1433270605;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2243577 : 154072;
        ...
        assert(block.hashMerkleRoot == uint256("0x3d3104c355e9b4951f88abb008c18e2e413d057d3807771b9cf03fb4bcb81750"));
        ...
        if (false && block.GetHash() != hashGenesisBlock)
        {
            ...
            #define BEGIN(a) ((const uint8_t*)&(a))
